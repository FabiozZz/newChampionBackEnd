...
const SelectImage = () => {
	...
	const svgsObjArray = svgs.keys().map(key => ({
		path: key,
		file: svgs(key),
	}));
	const selectImage = e => {
							...
							<>
								<div className={classes.svg}>
									<svg
										...
										<path
											d="M69 54V18C69 14.7 66.3 12 63 12H9C5.7 12 3 14.7 3 18V54C3 57.3 5.7 60 9 60H63C66.3 60 69 57.3 69 54ZM25.5 37.5L33 46.53L43.5 33L57 51H15L25.5 37.5Z"
											fill="#8798AD"
										/>
									</svg>
								</div>
