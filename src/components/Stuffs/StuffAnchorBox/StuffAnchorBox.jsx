...
export const StuffAnchorBox = ({select,clear,ancor}) => {
    return (
        <div className={cn({[classes.ancor]:(ancor&&select)},{[classes.ancor_fixed]:!select})}>
            <div className={cn("row",classes.ancor_wrapper)}>
                {ancor&&
                <div className={classes.ancor_box}>
                    <a href="#filters" className={classes.ancor__link}>Показать фильтры</a>
