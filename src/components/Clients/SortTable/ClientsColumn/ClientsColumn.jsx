...
export const ClientsColumn = ({clients}) => {
    return (
        <div className={'col-12'}>
            <div className={cn("row", classes.list_col)}>

                {clients.map(client => {

                    return (
                        <NavLink key={client.id} className={classes.wr_card_col} to={`/profile/${client.id}/info`}>
                                    ...
                                    {client.status !== 0 ?
                                        <>
                                            ...
                                            <div className={classes.list_col__item_block}>
                                                ...
                                                <span
                                                    className={classes.list_col__item_block_text}>{client.statusName} клиент</span>
                                            </div>
