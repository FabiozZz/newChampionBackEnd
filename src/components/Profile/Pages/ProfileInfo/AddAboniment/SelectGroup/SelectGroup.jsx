    ...
    return (
        <div ref={selectRef} className={`${classes.selectBoxWrapper} ${props.className}`} {...props}>
            ...
            <div className={classes.inputWrapper} onClick={handleToggleOptionBox}>
                ...
                <span/>
                <input required={required} ref={refInput} name={name} className={classes.input} value={value.name||''} onClick={handleChangeValue} disabled={true} type="text" placeholder={props.placeholder||'Не выбрано'}/>
