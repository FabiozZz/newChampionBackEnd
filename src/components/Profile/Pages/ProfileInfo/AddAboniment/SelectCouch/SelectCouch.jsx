    ...
    return (
        <div ref={selectRef} className={`${classes.selectBoxWrapper} ${props.className}`} {...props}>
            ...
            <div className={classes.inputWrapper} onClick={handleToggleOptionBox}>
                ...
                <span />
                <input readOnly className={classes.input} value={value.id === null?'':(`${value.last_name} ${value.first_name} ${value.middle_name}`)} disabled={true} type="text" placeholder={props.placeholder?props.placeholder:'Не выбрано'} />
