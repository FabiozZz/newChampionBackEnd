            ...
            <div className={classes.block_info__info_card}>
                ...
                <div>
                    ...
                    <p className={classes.block_info__info_card__label}>Срок
                        действия: <b>{moment(user.club_card.valid_from).format('DD.MM.YYYY')} &mdash; {moment(user.club_card.valid_until).format('DD.MM.YYYY')}.</b> Доступно <b>{user.club_card.train_balance>999?<span
