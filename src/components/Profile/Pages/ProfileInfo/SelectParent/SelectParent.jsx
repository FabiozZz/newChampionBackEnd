 ...
 * @constructor
 */
export const SelectParent = ({label, value, setValue, data, ...props}) => {
    ...
    useEffect(() => {
        if (value.first_name === '' || value.last_name === '' || value.middle_name === '') {
            setValue(data[0]);
        }
    }, [data, setValue, value]);
    ...
    return (
        <div ref={selectRef} className={`${classes.selectBoxWrapper} ${props.className}`} {...props}>
            ...
            <div className={classes.inputWrapper} onClick={handleToggleOptionBox}>
                <svg className={classes.arrow} width="11" height="6" viewBox="0 0 11 6" fill="none"
