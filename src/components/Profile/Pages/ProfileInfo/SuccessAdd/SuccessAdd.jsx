	...
	return (
		<div className={classes.wrapper}>
			<div className={classes.info_wrapper}>
				<p className={classes.info_head}>
					Абонемент &laquo;{user?.subscription?.rate?.name}&raquo; со статусом &laquo;
					{user?.level?.name} клиент&raquo; сохранен
				</p>
