 ...
 * @constructor
 */
export const SelectStatus = ({label,value,setValue,data,disabled=false,...props}) => {
    ...
    return (
        <div ref={selectRef} className={`${classes.selectBoxWrapper} ${props.className}`} {...props}>
            ...
            <div className={disabledClass} onClick={!disabled&&handleToggleOptionBox}>
                ...
                <span/>
                <input readOnly={true} className={classes.input} value={value} disabled={disabled} type="text" />
