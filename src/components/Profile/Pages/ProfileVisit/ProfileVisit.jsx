            ...
            <div className={classes.wrapper_result}>
                ...
                <div className={classes.wrapper_table}>
                    {(profile.visit_list&&profile.visit_list.length)?
                        <>
                            <p className={classes.table_caption}>Куплено абонементов: <span
                                className={classes.table_period}>12</span></p>
                        ...
                        :
                        <span className={classes.mute_text}>История клиента пуста</span>
                    }
                </div>
            </div>
        </>
