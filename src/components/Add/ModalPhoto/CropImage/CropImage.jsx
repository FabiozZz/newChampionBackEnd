...
/**
 * Компонент для обрезки сделанного\добавленного фото
 *
 * @param img {string} изображение
 * @param reboot {function} сброс картинки
 * @param abort {function} отмена загрузки
 * @param setImage {function} установки нового обрезанного изображение
 * @param toggle {function} переключение модалки
 * @returns {JSX.Element}
 * @constructor
 */
