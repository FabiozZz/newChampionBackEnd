			...
			<div className={classes.general}>
				<div className={classes.wrapper}>
					{abonements ? (
												...
												return (
													<tr
														...
														<td className={classes.left}>
															{item.name}
															{item.is_personal ? ' (персональный)' : null}
														</td>
														<td className={classes.left}>
						...
						<span className={classes.empty_data}>
							Вы ещё не добавили не одного тарифного плана
						</span>
					)}
				...
				{!!abonements.length &&
					!!abonements.filter(abonement => abonement.in_archive).length && (
						<div className={classes.wrapper}>
