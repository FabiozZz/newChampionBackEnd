...
export const AddedLesson = (props) => {
    ...
    const handleChangeGroup = (obj) => {
        setUserData(prevState => ({...prevState,group: {...obj}}));
    };
    useEffect(() => {
        if (isEmpty(props.item.trainer) ||isEmpty(props.item.group)) {
    ...
    return (
        <div className={classes.wrapper}>
            <div className={classes.first_line}>
                <SelectGroup setValue={handleChangeGroup} label={'группа'} value={userData.group} data={group}/>
